...
@section('title', __('admin.edit_conference'))
...
<div class="row justify-content-center mt-5">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <h2 class="mb-4">{{ __('admin.edit_conference') }}</h2>
                ...
                <form action="{{ route('admin.conferences.update', $conference['id']) }}" method="POST">
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-success">{{ __('admin.update_conference') }}</button>
